...
- health.py   : GET /health (root, via api.root_router) + GET /api/v1/health/protected  (M-v0.0.2-a)
- ingest.py   : POST /api/v1/ingest/{source}/pull + sync + GET /statuses  (M-v0.0.2-b)
- bundles.py  : GET/POST /api/v1/bundles + GET/POST /{name} + /rebuild  (M-v0.0.2-b)
